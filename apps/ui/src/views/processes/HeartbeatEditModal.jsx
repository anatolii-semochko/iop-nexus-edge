...
// 2" - shows what picking this level will actually sound like, sourced
// from Processes -> Settings -> Message Levels. Falls back to the bare
// label while messageLevels hasn't loaded yet, or if a row is missing.
